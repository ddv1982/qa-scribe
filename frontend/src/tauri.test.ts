...
describe('Tauri command bridge', () => {
  ...
  it('maps frontend wrappers to stable Tauri command names', async () => {
    ...
    await expectCommand('list_recent_sessions', () => tauri.listRecentSessions(50))
    ...
    await expectCommand('list_finding_library', () => tauri.listFindingLibrary())
    ...
    await expectCommand('list_draft_library', () => tauri.listDraftLibrary())
